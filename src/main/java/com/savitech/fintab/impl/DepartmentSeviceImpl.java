...
public class DepartmentSeviceImpl implements DepartmentService{
    ...
    @Override
    public ResponseEntity<?> createDepartment(CreateDepartmentDto departmentModel) {
    ...
    @Override
    public ResponseEntity<?> updateDepartment(String Id, CreateDepartmentDto departmentModel) {
        User user = authenticatedUser.auth();
        AdminUser adminUser = adminUserRepository.findByUserId(user.getId());
