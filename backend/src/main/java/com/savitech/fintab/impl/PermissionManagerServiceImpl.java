...
public class PermissionManagerServiceImpl implements PermissionManagerService{
    ...
    @Override
    public ResponseEntity<?> createRole(PermissionDto permissionModel) {
    ...
    @Override
    public ResponseEntity<?> updatePermistion(String Id, PermissionUpdateDto permissionUpdateModel) {
        User user = authenticatedUser.auth();
